...
export type FeedbackLoadingStage = {
  title: string;
  message: string;
};

export const INITIAL_FEEDBACK_LOADING_STAGES: FeedbackLoadingStage[] = [
  {
    title: "피드백을 만들고 있어요",
...
export const REWRITE_FEEDBACK_LOADING_STAGES: FeedbackLoadingStage[] = [
  {
